...
const chalk = require('chalk'); // color command line output 
const parse = require('react-docgen').parse; // pull metadeta out of components code 
const chokidar = require('chokidar'); // watch files and then run a function in cross platform way
...
function generate(paths) {
  ...
  writeFile(paths.output, "export default " + JSON.stringify(errors.length ? errors : componentData));
}
